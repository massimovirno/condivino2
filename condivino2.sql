...
(1, 'Cena a casa mia', '2018-07-10', 1, 50, 10, 'Il menu prevede un cous cous con melanzane e zucchine. Cortorno di peperoni', 'img/foto01.jpg'),
(2, 'BBQ in giardino', '2018-07-11', 2, 50, 5, 'Brace nel giardino con carni e bruschette', 'img/foto02.jpg');
...
--
ALTER TABLE `vino`
  ADD PRIMARY KEY (`num_vino`),
  ADD KEY `nome_vino` (`nome_vino`);
...
--
ALTER TABLE `evento`
  ADD CONSTRAINT `evento_ibfk_1` FOREIGN KEY (`vino_evento`) REFERENCES `vino` (`num_vino`);
